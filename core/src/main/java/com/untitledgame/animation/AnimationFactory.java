...
public class AnimationFactory {
    ...
    public static AnimationController createPlayerController(TextureAtlas atlas) {
        ...
        registerPlayerAnimation(controller, atlas, AnimationType.ATTACK, "melee_run", ATTACK_TICKS, Animation.PlayMode.NORMAL);
        ...
        registerPlayerAnimation(controller, atlas, AnimationType.TAKE_DAMAGE, "take_damage", ATTACK_TICKS, Animation.PlayMode.NORMAL);

        // Register BLOCK animations (parrying/shield blocking)
        registerPlayerAnimation(controller, atlas, AnimationType.BLOCK, "block_start", ATTACK_TICKS, Animation.PlayMode.NORMAL);
        registerPlayerAnimation(controller, atlas, AnimationType.BLOCK, "block_end", ATTACK_TICKS, Animation.PlayMode.NORMAL);

        // Register DEATH animations
        registerPlayerAnimation(controller, atlas, AnimationType.DEATH, "death", DEATH_TICKS, Animation.PlayMode.NORMAL);
